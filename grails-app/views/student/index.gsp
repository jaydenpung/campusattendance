		...
		<div id="list-student" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="telephoneNumber" title="${message(code: 'student.telephoneNumber.label', default: 'Tel No.')}" />
				...
				<g:each in="${studentInstanceList}" status="i" var="studentInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: studentInstance, field: "telephoneNumber")}</td>
